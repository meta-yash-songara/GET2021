...
function changeInputField(){
    ...
    if(click == 0){
        if(validateField()){
            ...
            message.innerHTML = "Hello " + inputField.value + ", Enter your email please.";
            inputField.value = "";
        ...
        if(validateField()){
            click = click + 1;
            message.innerHTML = "Well done " + localStorage.getItem("name") + ", now create a strong\npassword to keep your account safe.";
            inputField.value = "";
        ...
        click = click + 1;
        message.innerHTML = "Enter identification details (if any), or press enter to skip.";
        inputField.value = "";
        inputField.type = "text";
...
function getCurrency(){
    ...
    if(currency == "USD"){
        ...
        pass.innerHTML = "Your Pass Price : " + passPrice + " Yen.";
    }else{
        pass.innerHTML = "Your Pass Price : " + passPrice + " rupees";
    }
}