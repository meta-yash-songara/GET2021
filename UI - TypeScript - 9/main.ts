...
function validateField() : Boolean {
  let inputFieldValue = (<HTMLInputElement>document.getElementById("input-field")).value;
...
function changeInputField() : void {
  let inputField = <HTMLInputElement>document.getElementById("input-field");
  let message = <HTMLInputElement>document.getElementById("message");
  let messageVehicalForm = <HTMLInputElement>document.getElementById("message-vehical-form");
  let fields = <HTMLInputElement>document.getElementById("fields");
  let vehicleTypes = <HTMLInputElement>document.getElementById("vehicle-types");
...
function getPrices(id : string) {
  ...
  let daily = <HTMLInputElement>document.getElementById("daily");
  let monthly = <HTMLInputElement>document.getElementById("monthly");
  let yearly = <HTMLInputElement>document.getElementById("yearly");
...
function getCurrency() : void {
  ...
  let finalPrice = parseInt(passPrice, 10);
  if (currency == "USD") {
